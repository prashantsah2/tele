    ...
    return(
        <div className="flex flex-col justify-center items-center w-full bg-[#f3f3d2] min-h-[100vh]  pt-8 px-8 pb-8 max-sm:px-4">
            <div className="flex flex-col justify-center items-center w-full mb-4">
                ...
                <p className="flex font-outfit text-[41px] text-center text-[#222] max-lg:text-[31px] max-md:leading-[31px] max-sm:text-[21px] max-sm:leading-[24px]">{data.title}</p>
                <p className="flex font-outfit max-w-[1211px] text-sm text-center">
                    {data.titledesc}
                </p>
            </div>
            <div className="flex justify-center items-center gap-4 mt-5 max-lg:flex-col w-[75%] max-lg:w-[100%]">
