...
import { ChevronDown, MenuIcon, Phone, Search, User } from "lucide-react"
            ...
            {showServicesDropdown && (
              <div className="ml-9 space-y-2">
                <a href="/services/" onClick={() => setIsMobileMenuOpen(false)}>
                  <div className="flex items-center space-x-3 py-2 px-4 text-white hover:bg-primarybg rounded-lg transition-colors">
                    <div className="w-2 h-2 bg-primarybg rounded-full"></div>
