...
{title:'Outdoor Lighting', image:'/image/17.png'}
    ...
    return(
        <div className='flex flex-col justify-center items-center w-full bg-[#acc531] min-h-[100vh] pt-8 px-8 pb-8 max-sm:px-4'>
            ...
            <div className='flex flex-col justify-center items-center w-full mb-4 font-outfit text-[41x] text-[#555]'>
                ...
                <p className='flex text-[#222] text-[41px] '>{data.title}</p>
            </div>
            <div className='flex flex-row flex-wrap justify-center items-center w-full mb-4'>
                {data.list.map((item, index) => (
                    <div key={index} className='flex flex-col justify-center items-center w-1/3 p-4'>
