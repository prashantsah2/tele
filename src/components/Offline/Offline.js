...
export default function Offline() {
  ...
  return (
    <>
      <div className="min-h-screen bg-primarybg text-white pt-20">
        <motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <motion.div variants={textVariants}>
              <h1 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
                Why Offline <span className="text-primary">Lead Generation</span>{" "}
                works for Business
              </h1>

              <p className="text-lg leading-relaxed">
                {` With our panIndia field team, your brand gets direct access
to retailers, wholesalers, and business owners
who matter. From on-ground research and
distributor outreach to face-to-face business
development, we help you capture
opportunities that online campaigns often miss.
For growing brands and small businesses, this
means faster market penetration, stronger
offline visibility, and real conversions you can
trust. Whether your goal is more clients, new
markets, or stronger distribution channels—our
offline lead network delivers results beyond
the screen.
`}
              </p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-bold text-primary mb-3">
                Immediate Results, Maximum ROI
              </h3>
              <p className="text-sm leading-relaxed">
                Start seeing qualified traffic and conversions as soon as your
                ads go live. We prioritize targeting and ad content that turns
            ...
            >
              ...
              <p className="text-sm leading-relaxed">
                Reach your ideal customers with precision targeting, keyword
                research, and audience analysis to ensure your ad spend goes
            ...
            >
              ...
              <p className="text-sm leading-relaxed">
                Only pay when someone clicks. You set the budget, and we make
                sure every dollar is used efficiently to deliver results.
              </p>
            </motion.div>
          </motion.div>
        </motion.div>
