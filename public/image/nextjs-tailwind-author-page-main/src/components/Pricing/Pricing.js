...
let data = [
  ...
  { title: 'Ownership remains with the creator – this is a license to use, not ownership transfer' },
    ...
    return(
        <div className="flex flex-col w-full justify-center items-center max-w-[1381px] bg-[#ebffeb] px-8 pt-8 pb-8 mb-8 rounded-2xl">
           <div>
           ...
           <div className="flex flex-row justify-center items-center gap-2 w-full">
            <div className="flex flex-col min-h-[511px] flex-1 rounded-2xl flex-1">
               <div className="flex flex-col justify-start items-center border-2 border-[#7db522] min-h-[311px] flex-1 rounded-2xl pt-6 pb-6">
                ...
                <div className="flex flex-col justify-center items-start w-full p-4 mt-4">
                   {data.map((item,index)=>{

                    return(
                           <div key={index} className="flex flex-row justify-center items-center ml-4 my-2 px-7">
