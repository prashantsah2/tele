  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="w-full flex flex-row justify-center items-center">
        <div className="bg-[#5b3de18a] w-[50%] h-2"></div>
        <div className="bg-[#60e13ddd] w-[50%] h-2"></div>
      </div>
      ...
      <div className="flex flex-col justify-start align-center pr-11 min-w-[331px]">
        <div className="flex flex-col justify-start align-center">
           ...
           <Image src={`/image/logos/ra.png`} width={221} height={51} className="mt-5"  />
        </div>
      ...
      <div className="w-full flex justify-center items-center bg-[#454545] font-outfit text-sm text-white">
        a brand by @munosojin
      </div>
    </div>
  );
}
